...
class BaseAPITestCase(APITestCase):
    def setUp(self):
        ...
        response1 = self.client.post(token_url, {
            'username': 'alice',
            'password': 'pass'},
            format='json')
        response2 = self.client.post(token_url, {
            'username': 'bob',
            'password': 'pass'},
            format='json')
...
class ProjectTests(BaseAPITestCase):
    def test_list_projects(self):
        ...
        self.assertTrue(any(proj['id'] == self.project.pk for proj in projects))
...
class CommentTests(BaseAPITestCase):
    def test_list_comments_as_contributor(self):
        ...
        self.assertTrue(any(item['id'] == self.comment.pk for item in comments))
